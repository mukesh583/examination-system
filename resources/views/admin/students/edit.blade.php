        ...
        <div class="bg-white rounded-lg shadow p-6">
            <form action="{{ route('admin.students.update', $student) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="enrollment_year" id="enrollment_year" value="{{ old('enrollment_year', $student->enrollment_year) }}" required
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="program" id="program" value="{{ old('program', $student->program) }}" required
