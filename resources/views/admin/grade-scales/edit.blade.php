...
@section('header', 'Edit Grade Scale')
            ...
            <div class="mb-4">
                <label class="flex items-center">
                    <input 
                        ...
                        id="is_passing"
                        value="1"
                        {{ old('is_passing', $gradeScale->is_passing) ? 'checked' : '' }}
